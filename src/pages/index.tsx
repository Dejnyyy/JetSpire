      ...
      <section className="h-auto bg-black py-12">
        <div className="flex-auto items-center justify-center text-center sm:mx-12 md:mx-24 lg:mx-48 xl:mx-96">
          ...
          <h3 className="my-3 rounded-lg p-5 text-left font-mono  text-lg  text-white">
            Welcome to Jetspire, your indispensable ally for scaling the elusive
            peaks of online visibility. We don't just sprinkle a few SEO
            keywords and call it a day! Our AI, tailored to your needs, crafts
            ingenious solutions helping you ascend to the zenith of the Google
            ranks - no ads attached.
          </h3>
        </div>
      </section>
        ...
        <div className=" text-center">
          <div className="mx-8  mt-12 grid  grid-cols-1 gap-6 lg:mx-24 lg:grid-cols-3">
            <div className="m-1 rounded-lg border py-2">
              <h1 className="mt-3  p-1 font-mono font-semibold text-white md:text-xl  xl:text-xl">
                "Discoverability Boost"
              </h1>
              <p className="xl:text-md mt-3 px-3 font-mono text-sm text-white md:text-lg">
                Since partnering with this SEO-savvy team, our business is now
                more visible on Google. It's not just numbers—it's real clicks
                and connections that are driving our success.
              </p>
            ...
            <div className="m-1 rounded-lg border p-4">
              ...
              <p className="xl:text-md font mt-3 px-3 font-mono text-sm text-white md:text-lg">
                Thanks to this service, our website now shines higher on Google.
                It's more than numbers—it means more people finding us and
                choosing our offerings. Great tool for boosting online
                visibility!
              </p>
              <h1 className="mt-3 font-mono font-semibold text-white md:text-xl lg:text-2xl xl:text-lg">
                - KoelR
            ...
            <div className="m-1 rounded-lg border p-4">
              ...
              <p className="xl:text-md font mt-3 px-3 font-mono text-sm text-white md:text-lg">
                We've seen a positive shift in our online experience, all thanks
                to the improved Google ranking of our go-to brand. It's like
                they've become even more attuned to what we're looking for,
