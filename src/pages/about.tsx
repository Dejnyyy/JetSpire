  ...
  return (
    <div className="bg-black">
      ...
      <section className="h-auto bg-black py-8">
        <div className="flex-auto  items-center justify-center sm:mx-12 md:mx-36 lg:mx-56 xl:mx-96">
          ...
          <h3 className="my-3 rounded-lg p-3 px-24 font-mono  text-xl font-semibold text-white">
      ...
      <section className="bg-black pt-24 text-3xl   text-white">
        <div className="mx-4 px-8 md:mx-12 lg:mx-24 xl:mx-96">
